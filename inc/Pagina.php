<?php
	class Pagina
	{
		...
		{?>
			...
			<br>
			<marquee behavior="alternate" align="midldle" width="100%" height="50" class="prod_officeexpert">Instituto Superior Tecnologico Publico Julio Cesar Tello - Departamento de Computación e Informática
			</marquee>			
			<br>
