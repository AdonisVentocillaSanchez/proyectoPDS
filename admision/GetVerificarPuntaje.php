<?php //GetVerificarPuntaje.php desde FormControlCalidad.php desde desde indexControlCalidad.php desde boton
if(isset($consultarPostulante) and strcmp($login,"")!=0)
{
